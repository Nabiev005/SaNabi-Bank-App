        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View>
                  ...
                  <Text style={styles.balance}>
                    {index === 0 
                      ...
                      : item.balance.toLocaleString('ru-RU', { minimumFractionDigits: 2 })
                    } {item.currency}
                  </Text>
                </View>
          ...
          <View style={[styles.transactionCard, { marginBottom: 120 }]}>
             <View style={styles.transactionItem}>
               ...
               <Text style={styles.transAmountNegative}>-1 200 с.</Text>
             </View>
             ...
             <View style={[styles.transactionItem, {borderBottomWidth: 0}]}>
               ...
               <Text style={styles.transAmountPositive}>+45 000 с.</Text>
             </View>
          </View>
        </ScrollView>

        {/* --- MBANK СТИЛИНДЕГИ BOTTOM NAVIGATION --- */}
...
const styles = StyleSheet.create({
  ...
  bankName: { color: '#FFF', opacity: 0.5, letterSpacing: 1 },
  balanceLabel: { color: '#FFF', opacity: 0.6, fontSize: 12 },
  balance: { color: '#FFF', fontSize: 26, fontWeight: 'bold', marginTop: 5 },
